...
var map_AuthenticationProxyConfig = map[string]string{
	...
	"httpProxy":  "httpProxy is the URL of the proxy for HTTP requests. When set, authentication components will use this proxy for all outbound HTTP connections to external identity providers. When omitted, no HTTP proxy is configured for authentication components (unless inherited from the cluster-wide proxy).",
	"httpsProxy": "httpsProxy is the URL of the proxy for HTTPS requests. When set, authentication components will use this proxy for all outbound HTTPS connections to external identity providers, including OIDC discovery, token exchange, and user info requests. When omitted, no HTTPS proxy is configured for authentication components (unless inherited from the cluster-wide proxy).",

	...
	tests := []struct {
		...
		},
		{
			...
			want: &ResolvedProxy{
				...
				Config:        proxyConfig("", "http://proxy:3128", ".cluster.local,.svc,127.0.0.1,localhost"),
			},
		},
		{
			...
			want: &ResolvedProxy{
				...
				Config: proxyConfig("http://component:3128", "", ".cluster.local,.corp.example.com,.svc,127.0.0.1,idp.example.com,localhost"),
			},
		},
		{
			...
			want: &ResolvedProxy{
				...
				Config: proxyConfig("http://component:3128", "", ".cluster.local,.svc,127.0.0.1,idp.example.com,localhost"),
			},
		},
		{
			...
			want: &ResolvedProxy{
				...
				Config: proxyConfig("", "http://component:3129", ".cluster.local,.svc,127.0.0.1,localhost"),
			},
		},
		{
